...
class InvitationDetail extends StatefulWidget {
  final String id;
  InvitationDetail({Key key, @required this.id}) : super(key: key);
  @override
  _InvitationDetailState createState() => _InvitationDetailState(id);
}
...
class _InvitationDetailState extends State<InvitationDetail> {
  ...
  String id;
  String _token, _msg;
  _InvitationDetailState(this.id);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          ...
          title: Text("Invitations Details"),
        ),
        body: isLoading
            ? Container(
